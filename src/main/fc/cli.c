...
static void cliSwitchRoleChan(char *cmdline) {
    ...
    if (receiver == 1) {
        // Switch to UART1
        // serialPortSetIdentifier(0, SERIAL_PORT_USART1);
        // serialPortSetFunction(0, FUNCTION_RX_SERIAL);
        // serialPortSetBaudRate(0, 115200);
        // Disable UART2
        // serialPortDisable(1);
    } else if (receiver == 2) {
        // Switch to UART2
        // serialPortSetIdentifier(1, SERIAL_PORT_USART2);
        // serialPortSetFunction(1, FUNCTION_RX_SERIAL);
        // serialPortSetBaudRate(1, 115200);
        // Disable UART1
        // serialPortDisable(0);
    }
    */
